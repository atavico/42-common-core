...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/16 17:19:27 by atarsi            #+#    #+#             */
/*   Updated: 2022/10/10 19:29:45 by atarsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_rules(t_rules *rules, char *argv[])
{
	...
	rules->fork = ft_semaphore("/fork", rules->n_ph);
	rules->finish = ft_semaphore("/must eat", 0);
